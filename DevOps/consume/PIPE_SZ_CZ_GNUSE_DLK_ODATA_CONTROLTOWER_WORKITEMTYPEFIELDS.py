...
DimWorkItemTypeFieldsTemp = spark.read.parquet(sinkPath)

# COMMAND ----------

# Escreve o Dataframe no banco de dados

#DimWorkItemTypeFieldsTemp.write\
    #.format("jdbc")\
    #.mode("overwrite")\
    #.option("url", url)\
    #.option("dbtable", "dbo.DimWorkItemTypeFieldsTemp")\
    #.option("user", user)\
...
# Fim carga Consume WorkItemTypeFields
