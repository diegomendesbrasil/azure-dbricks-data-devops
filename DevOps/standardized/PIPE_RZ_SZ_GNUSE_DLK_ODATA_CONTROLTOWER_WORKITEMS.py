...
df_P1 = spark.read.json(sourcePath)
...
df_P2 = spark.read.json(sourcePath)
...
DfFinal = df\
  ...
  .withColumn('ABIProprietaryMethodology_IssueOwnerSK', df.ABIProprietaryMethodology_IssueOwnerSK.cast(IntegerType()))\
  .withColumn('ActivatedByUserSK', df.ActivatedByUserSK.cast(StringType()))\
  .withColumn('ActivatedDateSK', df.ActivatedDateSK.cast(StringType()))\
  ...
  .withColumn('BacklogPriority', df.BacklogPriority.cast(StringType()))\
  ...
  .withColumn('ChangedDateSK', df.ChangedDateSK.cast(StringType()))\
  .withColumn('ClosedByUserSK', df.ClosedByUserSK.cast(StringType()))\
  .withColumn('ClosedDateSK', df.ClosedDateSK.cast(StringType()))\
  .withColumn('CommentCount', df.CommentCount.cast(StringType()))\
  .withColumn('CreatedByUserSK', df.CreatedByUserSK.cast(StringType()))\
  .withColumn('CreatedDateSK', df.CreatedDateSK.cast(StringType()))\
  ...
  .withColumn('Custom_DateIdentified', df.Custom_DateIdentified.cast(StringType()))\
  .withColumn('Custom_Deadline', df.Custom_Deadline.cast(StringType()))\
  ...
  .withColumn('Custom_Executed_Today', df.Custom_Executed_Today.cast(StringType()))\
  ...
  .withColumn('Custom_FSID', df.Custom_FSID.cast(IntegerType()))\
  ...
  .withColumn('Custom_Scenario_Order', df.Custom_Scenario_Order.cast(StringType()))\
  ...
  .withColumn('Custom_SystemName', df.Custom_SystemName.casat(StringType()))\
  ...
  .withColumn('Effort', df.Effort.cast(StringType()))\
  ...
  .withColumn('ParentWorkItemId', df.ParentWorkItemId.cast(StringType()))\
  .withColumn('Priority', df.Priority.cast(StringType()))\
  ...
  .withColumn('Revision', df.Revision.cast(StringType()))\
  ...
  .withColumn('StateChangeDateSK', df.StateChangeDateSK.cast(LongType()))\
  ...
  .withColumn('Watermark', df.Watermark.cast(LongType()))\
